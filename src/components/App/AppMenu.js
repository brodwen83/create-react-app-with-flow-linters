...
function AppMenu() {
  ...
  const toggleMenu = val => {
    const isActive = activeMenu === val;
    setActiveMenu(isActive ? -1 : val);
  };
    ...
    <div className='layout-menu'>
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 0
        })}
      >
        <img
          alt='input'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/input.svg'
        />
        <img
          alt='input'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/input-active.svg'
        />
        <span>Input</span>
      </button>
      <CSSTransition
      ...
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 1
        })}
      >
        <img
          alt='button'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/button.svg'
        />
        <img
          alt='button'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/button-active.svg'
        />
        <span>Button</span>
      </button>
      <CSSTransition
      ...
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 3
        })}
      >
        <img
          alt='panel'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/panel.svg'
        />
        <img
          alt='panel'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/panel-active.svg'
        />
        <span>Panel</span>
      </button>
      <CSSTransition
      ...
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 4
        })}
      >
        <img
          alt='overlay'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/overlay.svg'
        />
        <img
          alt='overlay'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/overlay-active.svg'
        />
        <span>Overlay</span>
      </button>
      <CSSTransition
      ...
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 6
        })}
      >
        <img
          alt='menu'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/menu.svg'
        />
        <img
          alt='menu'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/menu-active.svg'
        />
        <span>Menu</span>
      </button>
      <CSSTransition
      ...
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 8
        })}
      >
        <img
          alt='message'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/message.svg'
        />
        <img
          alt='message'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/message-active.svg'
        />
        <span>Messages</span>
      </button>
      <CSSTransition
      ...
      <button
        ...
        className={classNames({
          'active-menuitem': activeMenu === 9
        })}
      >
        <img
          alt='misc'
          className='layout-menu-icon-inactive'
          src='showcase/resources/images/mono/misc.svg'
        />
        <img
          alt='misc'
          className='layout-menu-icon-active'
          src='showcase/resources/images/mono/misc-active.svg'
        />
        <span>Misc</span>
      </button>
      <CSSTransition
